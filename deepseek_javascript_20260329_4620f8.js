...
// @version      27.0
// @description  Auto click Thực Hiện + STEP + Xác nhận + Chuyển hướng tuần tự (chỉ khi có thông báo)
// @author       You
// @match        *://*/*
// @grant        none
// @run-at       document-end
...
(function() {
    ...
    // ==========================================
    // TÍNH NĂNG: CHUYỂN HƯỚNG TUẦN TỰ (CHỈ KHI CÓ THÔNG BÁO)
    // ==========================================
    ...
    function handleSequentialRedirect() {
        ...
        if (isHomePage) {
            console.log('🏠 Phát hiện trang chủ + thông báo, chuyển hướng đến:', domain + '/lien-he');
            setTimeout(() => {
        ...
        if (isLienHePage) {
            console.log('📞 Phát hiện trang lien-he + thông báo, chuyển hướng đến:', domain + '/gioi-thieu');
            setTimeout(() => {
    ...
    async function mainProcess() {
        ...
        try {
            // 1. Kiểm tra thông báo chuyển trang
            const hasNotification = checkForNotification();
            
            if (hasNotification) {
                console.log('⚠️ Phát hiện thông báo: NHẤN LINK BẤT KỲ ĐỂ TIẾP TỤC');
                
                // Nếu có thông báo, thực hiện chuyển hướng tuần tự
                ...
                // Nếu không thuộc các trường hợp chuyển hướng, vẫn về trang chủ
                goToHomePage();
                isProcessing = false;
                return;
            }

            // 2. Xử lý nút Thực Hiện
            await processThucHien();

            // 3. Xử lý nút Xác nhận trên moneytask.top
    ...
    console.log('  - Chuyển hướng tuần tự (trang chủ → /lien-he → /gioi-thieu) CHỈ KHI có thông báo');
